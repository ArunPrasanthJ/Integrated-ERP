...
CREATE TABLE `allocations` (
  ...
  KEY `room_id` (`room_id`),
  CONSTRAINT `allocations_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
...
INSERT INTO `allocations` VALUES (6,1,1,'2025-09-23 06:17:18'),(13,4,2,'2025-10-21 09:14:31');
